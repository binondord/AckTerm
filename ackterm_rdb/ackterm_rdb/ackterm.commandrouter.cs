...
//                    this.DispatchMessage (this, "\x1b[?64;1;2;6;7;8;9c");
                ...
                case "\x1b[t": // DECSLPP Set Lines Per Page
                    ...
                    if (Param > 0) this.SetSize (Param, this.Columns);
...
//                    CurTarget = uc_Chars.Sets.NRCDutch;
        ...
        {
            //prntSome.printSome("ClearCharAttribs");
        ...
        public void ExecuteChar (System.Char CurChar)
        {
            System.Int32 Xrdb = this.Caret.Pos.X;
            System.Int32 Yrdb = this.Caret.Pos.Y;
            //prntSome.printSome("ExecuteChar");
            switch (CurChar)
            {
                case '\x05': // ENQ request for the answerback message
                    this.DispatchMessage (this, "ansi");//"vt220");
                    prntSome.printSome("ENQ request for the answerback message", "montdis", countmontdisrdb);
                    countmontdisrdb++;
                    break;
                ...
                case '\x11': // DC1/XON continue sending characters
                    this.XOFF = false;
                    //prntSome.printSome("DC1/XON continue sending characters", "montdis",countmontdisrdb);
                    //countmontdisrdb++;
