public partial class ackterm
{
    ...
    {
        public System.Collections.Generic.List<string> Elements = new System.Collections.Generic.List<string>();
  
        public uc_Params ()
        {
            //prntSome.printSome("uc_Params");
        }
    
        public System.Int32 Count () 
        {
            //prntSome.printSome("Count");
            return this.Elements.Count;
        }
    
        public void Clear ()
        {
            //prntSome.printSome("Clear");
            this.Elements.Clear ();
        }
    ...
    private class uc_Parser
    {
        ...
        private void DoAction (Actions NextAction)
        {
            ...
            //rdbsb.AppendFormat("\tuc_parser doact {0}\n",NextAction);
            switch (NextAction)
            {
            ...
            switch (NextAction)
            {
                ...
                case Actions.Print:
                    ...
                    //prntSome.add2stringrdb(this.CurChar.ToString());
                    //rdbmsg.Append(System.String.Format("Sequence = {0}, Char = {1}, PrmCount = {2}, State = {3}, NextAction = {4}\n",
