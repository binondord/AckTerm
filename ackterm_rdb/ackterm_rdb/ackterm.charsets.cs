...
{
    /* This file contains the tables that substitute the characters received with
       those of the currently selected character set. I am assuming for the time being that
       the character sets being used by the host are Basic and Supplemental Latin.
       This means that the character tables are overlays over the top of these two sets.
       Where the overlayed char set does not have a corresponding char I am letting the
